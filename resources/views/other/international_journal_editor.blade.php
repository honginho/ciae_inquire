				...
				<div class="tab-content">
					...
					@endif
						...
						<table width="100%" class="table table-striped table-bordered table-hover">
							<thead>
								<tr>
									<td id="international_journal_editor.college" class="text-nowrap" onclick="sort(id)">一級單位
										<i class="fa fa-sort" aria-hidden="true"></i>
									</td>
									<td id="international_journal_editor.dept" class="text-nowrap" onclick="sort(id)">系所部門
										<i class="fa fa-sort" aria-hidden="true"></i>
									</td>
									<td id="name" class="text-nowrap" onclick="sort(id)">期刊編輯者
										<i class="fa fa-sort" aria-hidden="true"></i>
									</td>
									<td id="journalName" class="text-nowrap" onclick="sort(id)">期刊名稱
										<i class="fa fa-sort" aria-hidden="true"></i>
									</td>
									<td id="startDate" class="text-nowrap" onclick="sort(id)">開始擔任時間
										<i class="fa fa-sort" aria-hidden="true"></i>
									</td>
									<td id="endDate" class="text-nowrap" onclick="sort(id)">結束擔任時間
										<i class="fa fa-sort" aria-hidden="true"></i>
									</td>
							...
							<tbody>
								...
								<tr>
									...
									<td class="text-nowrap">
										@can('permission',$data)
										<a href="{{url('international_journal_editor',$data->id)}}" class="glyphicon glyphicon-pencil	
											btn btn-success btn-xs"></a>
										<form action="{{url('international_journal_editor',$data->id)}}" method="post"
					...
					<div class="tab-pane fade in col-md-12" id="download" style="margin-top: 10px;">
						<a class="btn btn-success" href="{{url('international_journal_editor/download')}}">下載所有資料</a>
					</div>
				</div>
            </div>
        </div>
