				...
				<div class="tab-content">
					...
					@endif
						...
						<table width="100%" class="table table-striped table-bordered table-hover">
							<thead>
								<tr>
									<td id="internationalize_activity.college" class="text-nowrap" onclick="sort(id)">一級單位
										<i class="fa fa-sort" aria-hidden="true"></i>
									</td>
									<td id="internationalize_activity.dept" class="text-nowrap" onclick="sort(id)">系所部門
										<i class="fa fa-sort" aria-hidden="true"></i>
									</td>
									<td id="activityName" class="text-nowrap" onclick="sort(id)">活動性質
										<i class="fa fa-sort" aria-hidden="true"></i>
									</td>
									<td id="place" class="text-nowrap" onclick="sort(id)">活動地點
										<i class="fa fa-sort" aria-hidden="true"></i>
									</td>
									<td id="host" class="text-nowrap" onclick="sort(id)">本校參加人員
										<i class="fa fa-sort" aria-hidden="true"></i>
									</td>
									<td id="guest" class="text-nowrap" onclick="sort(id)">參加之外賓
										<i class="fa fa-sort" aria-hidden="true"></i>
									</td>
							...
							<tbody>
								...
								<tr>
									...
									<td class="text-nowrap">
										@can('permission',$data)
										<a href="{{url('internationalize_activity',$data->id)}}" class="glyphicon glyphicon-pencil	
											btn btn-success btn-xs"></a>
										<form action="{{url('internationalize_activity',$data->id)}}" method="post"
					...
					<div class="tab-pane fade in col-md-12" id="download" style="margin-top: 10px;">
						<a class="btn btn-success" href="{{url('internationalize_activity/download')}}">下載所有資料</a>
					</div>
				</div>
			</div>
		</div>
