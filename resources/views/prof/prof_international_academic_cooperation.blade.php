	      		...
	      		<div class="tab-content">
					...
					@endif
						...
						<table width="100%" class="table table-striped table-bordered table-hover">
							<thead>
								<tr>
									<td id="prof_international_academic_cooperation.college" class="text-nowrap"
										onclick="sort(id)">一級單位
										<i class="fa fa-sort" aria-hidden="true"></i>
									</td>
									<td id="prof_international_academic_cooperation.dept" class="text-nowrap"
									...
									<td id="partnerNation" class="text-nowrap"
										onclick="sort(id)">合作國家
										<i class="fa fa-sort" aria-hidden="true"></i>
									</td>
									<td id="projectName" class="text-nowrap"
										onclick="sort(id)">計畫名稱
										<i class="fa fa-sort" aria-hidden="true"></i>
									</td>
									<td id="startDate" class="text-nowrap"
										onclick="sort(id)">執行期限（起）
										<i class="fa fa-sort" aria-hidden="true"></i>
									</td>
									<td id="endDate" class="text-nowrap"
										onclick="sort(id)">執行期限（迄）
										<i class="fa fa-sort" aria-hidden="true"></i>
									</td>
									<td id="money" class="text-nowrap"
										onclick="sort(id)">總核定金額
										<i class="fa fa-sort" aria-hidden="true"></i>
									</td>
								...
								<tr>
									...
									<td class="text-nowrap">
										...
										<form action="{{ url('prof_international_academic_cooperation',$data->id) }}"
