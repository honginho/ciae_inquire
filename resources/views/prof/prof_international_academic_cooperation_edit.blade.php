...
<div class="row">
	<div class="col-md-12">
		<h1 class="page-header">與國外及兩岸學校進行學術合作交流修改</h1>
	</div>
</div>
<div class="row">
	<div class="col-md-12">
		<div class="panel panel-default">
			<div class="panel-body">
				<form action="{{ url('prof_international_academic_cooperation',$id) }}" method="post">
					{{ method_field('PATCH') }}
					{{ csrf_field() }}
                    ...
                    @endif
						<div class="form-group">
							...
							<input type="text" name="partnerNation" class="form-control" value="{{ $partnerNation }}">
						</div>
                    ...
                    @endif
						<div class="form-group">
							...
							<textarea name="projectName" id="projectName" cols="30" rows="3" class="form-control">{{ $projectName }}</textarea>
						</div>
                    ...
                    @endif
						<div class="form-group">
							...
							<input type="text" name="money" class="form-control" value="{{ $money }}">
						</div>
