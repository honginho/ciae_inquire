...
<div class="row">
	<div class="col-md-12">
		<a href="{{URL('foreign_prof_exchange')}}" style="color:black">
			<h1 class="page-header">境外學者來校交換</h1>
		</a>
	</div>
</div>
<div class="row">
		...
		<div class="panel panel-default">
			<div class="panel-body">
				...
				<div class="tab-content">
					...
					@endif
						...
						<table width="100%" class="table table-striped table-bordered table-hover">
							<thead>
								<tr>
									<td id="foreign_prof_exchange.college" class="text-nowrap" onclick="sort(id)">一級單位
										<i class="fa fa-sort" aria-hidden="true"></i>
									</td>
									<td id="foreign_prof_exchange.dept" class="text-nowrap" onclick="sort(id)">系所部門
										<i class="fa fa-sort" aria-hidden="true"></i>
									</td>
							...
							<tbody>
								...
								<tr>
									...
									<td class="text-nowrap">
										@can('permission',$data)
										<a href="{{url('foreign_prof_exchange',$data->id)}}" class="glyphicon glyphicon-pencil
												btn btn-success btn-xs"></a>
										<form action="{{url('foreign_prof_exchange',$data->id)}}" method="post" style="display: inline;">
											{{ method_field('DELETE') }}
											{{ csrf_field() }}
				...
				<div class="tab-pane fade in col-md-12" id="download" style="margin-top: 10px;">
					<a class="btn btn-success" href="{{url('foreign_prof_exchange/download')}}">下載所有資料</a>
				</div>
            </div>
        </div>
	</div>
