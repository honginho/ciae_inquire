...
<div class="row">
	<div class="col-md-12">
		<a href="{{ URL('foreign_prof_speech_lecture') }}" style="color:black">
			<h1 class="page-header">境外學者來校演講、研習或講學活動</h1>
		</a>
	</div>
</div>
<div class="row">
			...
			<ul class="nav nav-tabs">
	            ...
	            @endif
	      		...
	      		<div class="tab-content">
					...
					@endif
						<form action="{{ url('foreign_prof_speech_lecture') }}" method="post">
							{{ csrf_field() }}
