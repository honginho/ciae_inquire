...
<div class="row">
	<div class="col-md-12">
		<a href="{{URL('short_term_foreign_stu')}}" style="color: black">
			<h1 class="page-header">境外學生至本校短期交流訪問或實習</h1>
		</a>
	</div>
</div>
<div class="row">
				...
				<div class="tab-content">
					...
					@endif
						...
						<table width="100%" class="table table-striped table-bordered table-hover">
							<thead>
								<tr>
									<td id="short_term_foreign_stu.college" class="text-nowrap" onclick="sort(id)">一級單位
										<i class="fa fa-sort" aria-hidden="true"></i>
									</td>
									<td id="short_term_foreign_stu.dept" class="text-nowrap" onclick="sort(id)">系所部門
										<i class="fa fa-sort" aria-hidden="true"></i>
									</td>
							...
							<tbody>
								...
								<tr>
									...
									<td class="text-nowrap">
										...
										<form action="{{url('short_term_foreign_stu',$data->id)}}" method="post" style="display: inline;">
											{{ method_field('DELETE') }}
											{{ csrf_field() }}
					...
					<div class="tab-pane fade in col-md-12" id="download" style="margin-top: 10px;">
						<a class="btn btn-success" href="{{url('short_term_foreign_stu/download')}}">下載所有資料</a>
					</div>
				</div>
			</div>
		</div>
